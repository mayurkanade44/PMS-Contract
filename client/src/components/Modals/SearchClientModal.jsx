      ...
      <div className="my-10 lg:my-1 w-[500px]">
        <div className="relative">
          ...
          {data?.contractNo ? (
            ...
            !skip && (
              <div className="mt-1 max-h-40 w-full overflow-auto rounded-md bg-white py-1 pl-2 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
